...
do	
	...
	Credit.Text = [[<font color="#f8042e">YT</font> @acsu123 | <font color="#5d6af2">DISCORD</font> .gg/actionteam]]
    ...
    if (isfile("ActionTeam_Intro.txt") and (tick() - tonumber(readfile("ActionTeam_Intro.txt"))) >= 86400) or not isfile("ActionTeam_Intro.txt") then
	...
	do
		if isfile("ActionTeamKeyV4.txt") or _G.MY_KEY_IS then
			local key = _G.MY_KEY_IS and _G.MY_KEY_IS or readfile("ActionTeamKeyV4.txt")
